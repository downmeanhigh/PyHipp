...
DPT.objects.processDirs(dirs=['sessioneye/array02','session01/array02'], cmd='import PyHipp as pyh; import DataProcessingTools as DPT; DPT.objects.processDirs(dirs=None, objtype=pyh.RPLLFP, saveLevel=1); DPT.objects.processDirs(dirs=None, objtype=pyh.RPLHighPass, saveLevel=1);'); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:710823608214:awsnotify --message "RP2JobDone"
